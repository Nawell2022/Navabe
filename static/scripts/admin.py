...
"""Fonctions statiques (pour Admin)"""
...
def statistics_of_sales(option: str) -> dict:
    """
    Dépendamment de l'option choisie, retourne les nombres de ventes
    :param option: 'c' pour catégorie et 'm' pour l'affichage par mois
    :return:
    """
    return {}
...
if __name__ == "__main__":
    print(search_order("2023041001A63964"))
