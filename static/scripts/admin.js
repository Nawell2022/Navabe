    ...
    methods: {
        ...
        register_admin() {
            ...
            if (this.name.length > 0 &&
                ...
                fetch('/administration/set-new-admin', {
                    method: "POST",
                    body: data
                })
                    .then(response => response.json())
...
const DataVisualisation = {
    ...
    methods: {
        ...
        Stat_sales_Chart(data_){
            //Graphique de ventes(2 choix: ventes par categorie et le ventes mensuelles [choix par défaut])
            ...
            const options = {
                scales : {
                    ...
                    x:{
                        title:{
                            display: true,
                            text: data.labels[0] ==="Janvier" ? 'Month' : 'Category',
                            color: 'Black',
                            font:{
                                family:"Times",
                                size : 15
    ...
    watch:{
        ...
        choice_sv(newValue){
            //this.get_statData(newValue, "osl");
        },
        choice_sa(newValue){
    ...
    mounted: function () {
        ...
        //this.Stat_sales_Chart();
        //this.Stat_Average_Chart();        
    }
}
